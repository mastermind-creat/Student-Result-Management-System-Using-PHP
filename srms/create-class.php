                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">Eg- DICT, DEET, DCE, CICT etc</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                     ...
                                                     <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="text" name="section" class="form-control" maxlength="50" required="required" id="success">
                                                            <span class="help-block">Eg- COMPUTING, ELECTRICAL, BUILDING etc</span>
                                                        </div>
                                                    </div>
  <div class="form-group has-success">
