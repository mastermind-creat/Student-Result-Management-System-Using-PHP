...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/logo.css" media="screen">
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <div>
                                                        <div class="logo">
                                                            <h6 align="center"><img src="images/logo.jpeg" alt="logo"></h6>
                                                        </div>
                                                        <b><h3 class="title" align="center">SEME TECHNICAL AND VOCATIONAL COLLEGE</h3></b>
...
<?php
        ...
        <p><b>Student ADM/Reg No. :</b> <?php echo htmlentities($row->RollId);?>
...
<tr>
    <td colspan="3" align="left" color="green">
    <p><b>KEY TO GRADING SYSTEM</b></p>
    <P><i> Applicable for TVET and Higher Educational systems</i></P>
        <ul>
            <li>Distinction 1 (85-100)</li>
            <li>Distinction 2 (76-84)</li>
            <li>Credit 3 (68-75)</li>
            <li>Credit 4 (60-67)</li>
            <li>Pass 5 (50-59)</li>
            <li>Pass 6 (40-49)</li>
            <li>Refer (35-39)</li>
            <li>Fail (0-34)</li>
